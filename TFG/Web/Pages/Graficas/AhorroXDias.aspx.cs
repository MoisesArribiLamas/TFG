...
{
    public partial class AhorroXDias : System.Web.UI.Page
    {
        ...
        protected string ahorroPorDias()
        {
            ...
            List<AhorroPorDias> ahorros = serviceBateria.MostrarAhorroXUbicacionPorFechaEnDias(ubicacion.ubicacionId, fechaIni, fechaFin);
            ...
            foreach (AhorroPorDias dr in ahorros)
            {
                ...
                //}
                strDatos = strDatos + "[";
                strDatos = strDatos + "'" + fecha + "'" + "," + ahorro; 
                strDatos = strDatos + "],";
            }
