<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CargaSuministraVSRedDiaConcreto.aspx.cs" Inherits="Es.Udc.DotNet.TFG.Web.Pages.Graficas.CargaSuministraVSRedDiaConcreto" MasterPageFile="~/TFG.Master" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" trace="false" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['<%=dia()%>', '<%=carga()%>', '<%=suministra()%>', '<%=red()%>'],<%=suministradoCargadoyRed()%>);
    ...
    <form id="form1" runat="server" >
        ...
        <div>
            <div id="columnchart_material" style="width: 900px; height: 380px;"></div>
        </div>
