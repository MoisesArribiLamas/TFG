<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AhorroXDias.aspx.cs" Inherits="Es.Udc.DotNet.TFG.Web.Pages.Graficas.AhorroXDias" MasterPageFile="~/TFG.Master" culture="auto" meta:resourcekey="PageResource2" uiculture="auto" Trace="true" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable(<%=ahorroPorDias()%>);
    ...
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblahorroTotal" runat="server" Text="Ahorro Total :" Display="Dynamic" Font-Size="Large" meta:resourcekey="lblahorroTotal" BackColor="#0066CC"></asp:Label>
        <asp:Label ID="lblahorro" runat="server" Display="Dynamic" Font-Size="Large"></asp:Label>
        <asp:Label ID="lbleuros" runat="server" Text="€" Display="Dynamic" Font-Size="Large"></asp:Label>

        <div>
            <div id="piechart" style="width: 900px; height: 368px;"></div>
        </div>
