<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModifyUser.aspx.cs" Inherits="Es.Udc.DotNet.TFG.Web.Pages.ModifyUser" MasterPageFile="~/TFG.Master" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
        ...
        <form id="form1" runat="server">
            ...
            <div class="field">
                <span class="label">
                    ...
                    <asp:Localize ID="Localize4ModifyUser2" runat="server" Text="2º Apellido" meta:resourcekey="Localize4ModifyUserResource2"></asp:Localize>
